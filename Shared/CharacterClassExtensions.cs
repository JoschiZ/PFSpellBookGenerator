...
public static class CharacterClassExtensions
{
    public static Tradition GetTradition(this CharacterClass.Pathfinder2 characterClass)
    {
        return characterClass switch
        {
            ...
            CharacterClass.Pathfinder2.Champion => Tradition.None,
            ...
            CharacterClass.Pathfinder2.Monk => Tradition.None,
            CharacterClass.Pathfinder2.Oracle => Tradition.Divine,
            CharacterClass.Pathfinder2.Psychic => Tradition.Occult,
            CharacterClass.Pathfinder2.Ranger => Tradition.None,
            CharacterClass.Pathfinder2.Sorcerer => Tradition.None,
            CharacterClass.Pathfinder2.Summoner => Tradition.None,
            CharacterClass.Pathfinder2.Witch => Tradition.None,
